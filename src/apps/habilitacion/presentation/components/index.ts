...
export { default as CumplimientoDetailModal } from './CumplimientoDetailModal';
...
export { default as EstandarFormModal } from './EstandarFormModal';
...
export { default as ResumenPanel } from './ResumenPanel';
