...
export const exportReporteCompletoExcel = (
  ...
  const resumenData = [
    ...
    { Campo: 'Sede', Valor: prestador.headquarters_detail?.name || 'N/A' },
    { Campo: 'Empresa', Valor: prestador.company_detail?.name || prestador.company_name || 'N/A' },
...
export const exportReportePrestadorPDF = (
  ...
  (doc as any).autoTable({
    body: [
      ...
      ['Sede', prestador.headquarters_detail?.name || 'N/A'],
      ['Empresa', prestador.company_detail?.name || prestador.company_name || 'N/A'],
