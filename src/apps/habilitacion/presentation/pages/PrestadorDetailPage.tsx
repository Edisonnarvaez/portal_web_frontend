...
const PrestadorDetailPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 sm:p-6 lg:p-8">
      ...
      {/* ── Status banner ── */}
      <div className={`rounded-xl p-4 mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 ${
        ...
        <div className="flex items-center gap-3">
          <HiOutlineShieldCheck className={`h-6 w-6 ${
            vencimientoEstado === 'vencido' ? 'text-red-600' : vencimientoEstado === 'proximo' ? 'text-yellow-600' : 'text-green-600'
          }`} />
          <div>
