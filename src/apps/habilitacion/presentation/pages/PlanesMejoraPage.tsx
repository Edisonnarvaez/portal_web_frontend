              ...
              >
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full transition-all ${
                        plan.porcentaje_avance >= 75 ? 'bg-green-500' :
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-gray-500 dark:text-gray-400 mb-4">
                  <div>
                    ...
                    <span className="text-gray-700 dark:text-gray-300">{plan.responsable || '—'}</span>
                  </div>
                  <div>
              ...
              {filtered.map(plan => {
                ...
                return (
                  <tr key={plan.id} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                    ...
                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">{plan.responsable || '—'}</td>
